  ...
  useEffect(() => {
    ...
    apiService
      ...
      .then((data) => {
        ...
        setcreateTime(time.toLocaleString("zh-TW"));
      })
      .catch((error) => {
        if (
            ...
            <ul>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                    <g fill="none" fillRule="evenodd">
                      ...
                      <path fill="currentColor"
                            d="M11.063 2.469a1.5 1.5 0 0 1 1.753-.087l.121.087l4.312 3.45a2 2 0 0 1 .743 1.38L18 7.48V10h2a2 2 0 0 1 1.995 1.85L22 12v7.9a1.1 1.1 0 0 1-.98 1.094L20.9 21H3.1a1.1 1.1 0 0 1-1.094-.98L2 19.9V12a2 2 0 0 1 1.85-1.995L4 10h2V7.48a2 2 0 0 1 .614-1.442l.137-.12l4.312-3.45ZM12 4.28l-4 3.2V19h8V7.48l-4-3.2ZM20 12h-2v7h2v-7ZM6 12H4v7h2v-7Zm6-4a3 3 0 1 1 0 6a3 3 0 0 1 0-6Zm0 2a1 1 0 1 0 0 2a1 1 0 0 0 0-2Z"></path>
                    </g>
                  </svg>
                  <p>學校</p>
                </div>
              ...
              <li className="list_item">
                <div className="list_title">
                  ...
                  >
                    <path
                        d="M240,192h-8V56a16,16,0,0,0-16-16H40A16,16,0,0,0,24,56V192H16a8,8,0,0,0,0,16H240a8,8,0,0,0,0-16ZM40,56H216V192H200V168a8,8,0,0,0-8-8H120a8,8,0,0,0-8,8v24H72V88H184v48a8,8,0,0,0,16,0V80a8,8,0,0,0-8-8H64a8,8,0,0,0-8,8V192H40ZM184,192H128V176h56Z"></path>
                  </svg>
                  <p>班級</p>
                </div>
